...
#define WIFI_SSID "DuvalVillas_Resident"
#define WIFI_PASSWORD "duvalresident"
...
//const char * url = "Akhila";
//uint8_t ndefprefix = NDEF_URIPREFIX_NONE;

//const char * url = "Sarnab";
//uint8_t ndefprefix = NDEF_URIPREFIX_NONE;
...
void loop() {
  ...
  //Firebase.setInt("uidLength", uidLength);
}
